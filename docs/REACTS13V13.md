# VIDEO 13: Juego adivina el pokemon!

Hemos desarrollado toda la lógica del juego de adivinar pokemons, nuestro componente ha quedado así:
...
Hemos hecho uso de una función de generación de números random:
